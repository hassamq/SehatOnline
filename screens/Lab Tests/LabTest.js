    ...
    return (
      ...
      >
        ...
        <View style={styles.testItemTextContainer}>
          <Text style={[styles.testItemName, isSelected && styles.selectedTestText]}>{item.name}</Text>
  ...
  const renderScheduleItem = (schedule) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => handleScheduleSelection(schedule)}
      >
        <Text style={[styles.scheduleText, isSelected && styles.selectedScheduleText]}>{schedule}</Text>
      </TouchableOpacity>
    );
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.contentContainer}>
          ...
          <View style={styles.scheduleContainer}>
            {renderScheduleItem("Morning")}
            {renderScheduleItem("Afternoon")}
            {renderScheduleItem("Evening")}
          </View>
